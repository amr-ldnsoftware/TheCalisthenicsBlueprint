...
public class AdvLevel2Week1 extends Fragment implements CompoundButton.OnCheckedChangeListener, RatingBar.OnRatingBarChangeListener{
    private static final String TAG = "ADV1_Level2_Week1";

    private static final String SHARED_PREFS211= "sharedPrefs211";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.adv_level2_week1,container,false);

        complete_workout_monday71 = (CheckBox) view.findViewById(R.id.checkBox_adv2wk1_monday);
        complete_workout_tuesday71 = (CheckBox) view.findViewById(R.id.checkBox_adv2wk1_Tuesday);
        complete_workout_wednesday71 = (CheckBox) view.findViewById(R.id.checkBox_adv2wk1_wednesday);
        complete_workout_friday71 = (CheckBox) view.findViewById(R.id.checkBox_adv2wk1_friday);
        complete_workout_saturday71 = (CheckBox) view.findViewById(R.id.checkBox_adv2wk1_Saturday);


        ratingBar = (RatingBar) view.findViewById(R.id.ratingBar_a2w1);
        ratingBar.setOnRatingBarChangeListener(this);
        sharedPreferences_rating = getActivity().getSharedPreferences("something211", Context.MODE_PRIVATE);
        float rating = sharedPreferences_rating.getFloat("float211", 0f);
        ...
        ImageButton wed_slowmups = view.findViewById(R.id.wed_slowmups);
        ImageButton wed_handstandpushups = view.findViewById(R.id.wed_handstandpushups);
        ImageButton wed_handstandpushups2 = view.findViewById(R.id.wed_handstandpushups2);
        ...
        wed_handstandpushups2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), Youtube_Handstand_Pushups.class);
                startActivity(intent);
        ...
        wed_slowmups.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        switch (buttonView.getId()) {
            ...
            case R.id.checkBox_adv2wk1_monday:

                break;


            case R.id.checkBox_adv2wk1_Tuesday:

                break;


            case R.id.checkBox_adv2wk1_wednesday:

                break;


            case R.id.checkBox_adv2wk1_friday:

                break;

            case R.id.checkBox_adv2wk1_Saturday:
    ...
    public void saveData(){
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(SHARED_PREFS211, Context.MODE_PRIVATE);
    ...
    public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
        ...
        editor_rating.putFloat("float211", rating);
        editor_rating.putInt("numStars211", numStars);
        editor_rating.apply();
    }
}
