...
public class AdvLevel3Week3 extends Fragment implements CompoundButton.OnCheckedChangeListener, RatingBar.OnRatingBarChangeListener{
    private static final String TAG = "ADV1_Level3_Week3";

    private static final String SHARED_PREFS223= "sharedPrefs223";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.adv_level3_week3,container,false);

        complete_workout_monday71 = (CheckBox) view.findViewById(R.id.checkBox_adv3wk3_monday);
        complete_workout_tuesday71 = (CheckBox) view.findViewById(R.id.checkBox_adv3wk3_Tuesday);
        complete_workout_wednesday71 = (CheckBox) view.findViewById(R.id.checkBox_adv3wk3_wednesday);
        complete_workout_friday71 = (CheckBox) view.findViewById(R.id.checkBox_adv3wk3_friday);
        complete_workout_saturday71 = (CheckBox) view.findViewById(R.id.checkBox_adv3wk3_Saturday);


        ratingBar = (RatingBar) view.findViewById(R.id.ratingBar_a3w3);
        ratingBar.setOnRatingBarChangeListener(this);
        sharedPreferences_rating = getActivity().getSharedPreferences("something223", Context.MODE_PRIVATE);
        float rating = sharedPreferences_rating.getFloat("float223", 0f);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        switch (buttonView.getId()) {
            ...
            case R.id.checkBox_adv3wk3_monday:

                break;


            case R.id.checkBox_adv3wk3_Tuesday:

                break;


            case R.id.checkBox_adv3wk3_wednesday:

                break;


            case R.id.checkBox_adv3wk3_friday:

                break;

            case R.id.checkBox_adv3wk3_Saturday:
    ...
    public void saveData(){
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(SHARED_PREFS223, Context.MODE_PRIVATE);
    ...
    public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
        ...
        editor_rating.putFloat("float223", rating);
        editor_rating.putInt("numStars223", numStars);
        editor_rating.apply();
    }
}
