...
public class IntLevel2Week2 extends Fragment implements CompoundButton.OnCheckedChangeListener, RatingBar.OnRatingBarChangeListener{
    private static final String TAG = "INT1_Level2_Week2";

    private static final String SHARED_PREFS82= "sharedPrefs82";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.int_level2_week2,container,false);


        complete_workout_monday71 = (CheckBox) view.findViewById(R.id.checkBox_int2wk2_monday);
        complete_workout_tuesday71 = (CheckBox) view.findViewById(R.id.checkBox_int2wk2_Tuesday);
        complete_workout_thursday71 = (CheckBox) view.findViewById(R.id.checkBox_int2wk2_thursday);
        complete_workout_friday71 = (CheckBox) view.findViewById(R.id.checkBox_int2wk2_friday);
        complete_workout_saturday71 = (CheckBox) view.findViewById(R.id.checkBox_int2wk2_saturday);



        ratingBar = (RatingBar) view.findViewById(R.id.ratingBar_i2w2);
        ratingBar.setOnRatingBarChangeListener(this);
        sharedPreferences_rating = getActivity().getSharedPreferences("something82", Context.MODE_PRIVATE);
        float rating = sharedPreferences_rating.getFloat("float82", 0f);
        ...
        ImageButton tues_leverraises = view.findViewById(R.id.tues_leverraises);
        ...
        ImageButton thurs_weightedpushups = view.findViewById(R.id.thurs_weightedpushups);
        ImageButton thurs_dragonfflags = view.findViewById(R.id.thurs_dragonfflags);
        ...
        ImageButton fri_backextensions2 = view.findViewById(R.id.fri_backextensions2);
        ...
        ImageButton sat_pulls2 = view.findViewById(R.id.sat_pulls2);
        ImageButton sat_ringpushes = view.findViewById(R.id.sat_ringpushes);
        ...
        tues_leverraises.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        thurs_dragonfflags.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), Youtube_Dragonflags.class);
                startActivity(intent);
        ...
        fri_backextensions2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), Youtube_BackExtensions.class);
                startActivity(intent);
        ...
        sat_pulls2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), Youtube_Normal_Pullup.class);
                startActivity(intent);
        ...
        sat_ringpushes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        switch (buttonView.getId()) {
            ...
            case R.id.checkBox_int2wk2_monday:

                break;


            case R.id.checkBox_int2wk2_Tuesday:

                break;


            case R.id.checkBox_int2wk2_thursday:

                break;


            case R.id.checkBox_int2wk2_friday:

                break;

            case R.id.checkBox_int2wk2_saturday:
    ...
    public void saveData(){
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences(SHARED_PREFS82, Context.MODE_PRIVATE);
    ...
    public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
        ...
        editor_rating.putFloat("float82", rating);
        editor_rating.putInt("numStars82", numStars);
        editor_rating.apply();
    }
}
